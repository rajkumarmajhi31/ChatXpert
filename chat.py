...
if st.button("Connect with Rajkumar Majhi"):
    # Use JavaScript to trigger the link opening upon button click
    st.markdown(
        '<a href="https://www.linkedin.com/in/rajkumar-majhi-1278b5226/" target="_blank">Click here to connect with me on LinkedIn</a>',
